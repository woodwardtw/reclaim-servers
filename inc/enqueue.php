...
function reclaim_enqueue_admin_script( $hook ) {  
    wp_enqueue_style( 'reclaim-admin-css', get_template_directory_uri() . '/css/admin.css', array(), '1.0' );
}
add_action( 'admin_enqueue_scripts', 'reclaim_enqueue_admin_script' );